...
module.exports = async function welcomeImage(background, avatar, text_1, text_2, text_3, color, settings) {
    try {
        ...
        throw new Error("[Mocy] => Cannot find module 'canvas' Please do ' npm i canvas@latest '")
    }
    ...
    await Canvas.loadImage(avatar)
        ...
        return new Discord.MessageAttachment(canvas.create.toBuffer(), `${attachmentName}.jpg`);
}